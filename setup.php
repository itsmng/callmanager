...
use GlpiPlugin\CallManager\CallManagerMenu;
use User;
...
function plugin_init_callmanager()
{
    ...
    if (Session::haveRight('plugin_callmanager_access', READ)) {
        $PLUGIN_HOOKS['menu_toadd']['callmanager']['helpdesk'] = CallManagerMenu::class;
    }
}
